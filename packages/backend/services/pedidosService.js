...
import {consultaPedidoMapper, estadoMapper, pedidoMapper} from "../mappers/mappers.js";
...
export default class PedidosService {
    ...
    consultarHistorialPedidos(usuario) {
        const filtroUsuario = consultaPedidoMapper.pedidosSegun(usuario)

        return this.pedidosRepository.findByUsuario(filtroUsuario)
    }
